...
{   
    ...
    try 
		{
            ...
            $Consulta="SELECT Codigo_Alumno,DUI,Nombres,Apellidos,Domicilio,Telefono,Email,Carrera,Foto,Cede FROM estudiante ORDER BY Nombres ASC";
	...
	public function Personal ($Codigo){     
		try 
			{
				$pdo;  
