...
<div class="col s3">
<?php foreach($this->model_profile->ProfileFicha() as $r): ?>
      ...
      <input type="hidden" id="Id_Oferta" name="Id_Oferta">
        ...
        <div class="card-action">
          <center>
          <a href=""  class="white-text text-darken-2"><H6 class="font-weight-light">Nombre: <?php echo $_SESSION['user'];?></H6></a>
          </center>
          </div>
        </div>
      </div>
...
<ul class="collection">
    ...
    <li class="collection-item avatar">
      ...
      <?php foreach($this->model_profile->ProfileCurriculum() as $s): ?>
